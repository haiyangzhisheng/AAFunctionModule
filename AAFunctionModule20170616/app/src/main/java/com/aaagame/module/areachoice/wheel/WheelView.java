...
package com.aaagame.module.areachoice.wheel;
...
import com.aaagame.module.areachoice.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	 ...
	 */
    private int[] SHADOWS_COLORS = new int[]{0xefFAFAFA, 0xcfFAFAFA, 0x3fFAFAFA};
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.app_line));
        // 设置线宽

...
public class BaiduMapUtilByRacer {
    ...
    /**
     * @Title: getBitmapFromView @Description: 通過view得到位圖 @param
     * view @return @return Bitmap @throws
     */
    ...
    /**
     * @Title: showMarkerByResource @Description: 通過resource來顯示Marker @param
     * lat @param lon @param mBitmap @param mBaiduMap @param distance @param
     * isMoveTo @return Marker @throws
     */
    public static Marker showMarkerByResource(double lat, double lon, int resource, BaiduMap mBaiduMap, int distance,
                                              boolean isMoveTo) {
        BitmapDescriptor bdView = BitmapDescriptorFactory.fromResource(resource);
        OverlayOptions ooView = new MarkerOptions().position(new LatLng(lat, lon)).icon(bdView).zIndex(distance)
                .draggable(true);
        if (isMoveTo) {
    ...
    /**
     * @Title: showMarkerByBitmap @Description: 通過bitmap來顯示Marker @param
     * lat @param lon @param mBitmap @param mBaiduMap @param distance @param
     * isMoveTo @return Marker @throws
     */
    public static Marker showMarkerByBitmap(double lat, double lon, Bitmap mBitmap, BaiduMap mBaiduMap, int distance,
                                            boolean isMoveTo) {
    ...
    /**
     * @Title: updateMarkerIcon @Description: @param mMarker @param
     * resourceId @return void @throws
     */
    ...
    /**
     * @Title: showMarkerByView @Description: 通過view來顯示Marker @param lat @param
     * lon @param mView @param mBaiduMap @param distance @param isMoveTo @return
     * Marker @throws
     */
    public static Marker showMarkerByView(double lat, double lon, View mView, BaiduMap mBaiduMap, int distance,
                                          boolean isMoveTo) {
    ...
    /**
     * @Title: showInfoWindowByBitmap @Description: 通過bitmap來顯示InfoWindow @param
     * lat @param lon @param mView @param mBaiduMap @param distance @param
     * isMoveTo @param listener @return @return InfoWindow @throws
     */
    public static InfoWindow showInfoWindowByBitmap(double lat, double lon, Bitmap mBitmap, BaiduMap mBaiduMap,
                                                    int distance, boolean isMoveTo, OnInfoWindowClickListener listener) {
        InfoWindow mInfoWindow = new InfoWindow(mBitmap == null ? null : BitmapDescriptorFactory.fromBitmap(mBitmap),
    ...
    /**
     * @Title: showPopByView @Description: 通過view來顯示InfoWindow @param lat @param
     * lon @param mView @param mBaiduMap @param distance @param isMoveTo @param
     * listener @return @return InfoWindow @throws
     */
    public static InfoWindow showInfoWindowByView(double lat, double lon, View mView, BaiduMap mBaiduMap, int distance,
                                                  boolean isMoveTo, OnInfoWindowClickListener listener) {
        InfoWindow mInfoWindow = new InfoWindow(BitmapDescriptorFactory.fromView(mView), new LatLng(lat, lon), distance,
                listener);
        mBaiduMap.showInfoWindow(mInfoWindow);
        if (isMoveTo) {
            moveToTarget(lat, lon, mBaiduMap);
    ...
    /**
     * @Title: moveToTarget @Description:移動到該點 @param lat @param log @param
     * mBaiduMap @return void @throws
     */
    ...
    /**
     * @Title: setZoom @Description: 縮放地圖的 @param zoomLevel @param
     * mBaiduMap @return void @throws
     */
    ...
    /**
     * @Title: zoomIn @Description: 放大地圖 @param mMapView @return void @throws
     */
    ...
    /**
     * @Title: zoomOut @Description: 縮小地圖 @param mMapView @return void @throws
     */
    ...
    /**
     * @Title: goneMapViewChild @Description: 隱藏百度logo亦或百度自帶的縮放鍵 @param
     * mMapView @param goneLogo @param goneZoomControls @return void @throws
     */
    ...
    /**
     * @Title: startLocate @Description: 定位 @param mContext @param time
     * 大於1000既會間隔定位 @param listener @return void @throws
     */
    ...
    /**
     * @Title: stopAndDestroyLocate @Description: 停止及置空mLocationClient @return
     * void @throws
     */
    ...
    /**
     * @Title: getDistance @Description: 獲取距離 Stirng類型的 @param mLat1 @param
     * mLon1 @param mLat2 @param mLon2 @return @return String @throws
     */
    public static String getDistanceWithUtil(double mLat1, double mLon1, double mLat2, double mLon2) {
        if ((Double) mLat1 instanceof Double && (Double) mLon1 instanceof Double && (Double) mLat2 instanceof Double
                && (Double) mLon2 instanceof Double && mLat1 != 0 && mLon1 != 0 && mLat2 != 0 && mLon2 != 0) {
    ...
    /**
     * @Title: getDistanceForInteger @Description: 獲取距離 int類型的 @param
     * mLat1 @param mLon1 @param mLat2 @param mLon2 @return @return int @throws
     */
    ...
    public static String getDistanceWithUtil(String mLat1, String mLon1, String mLat2, String mLon2) {
        if (mLat1 != null && !mLat1.equals("") && !mLat1.equals("null") && !mLat1.equals("0") && mLon1 != null
                && !mLon1.equals("") && !mLon1.equals("null") && !mLon1.equals("0") && mLat2 != null
                && !mLat2.equals("") && !mLat2.equals("null") && !mLat2.equals("0") && mLon2 != null
                && !mLon2.equals("") && !mLon2.equals("null") && !mLon2.equals("0")) {
            float distance = (float) DistanceUtil.getDistance(new LatLng(Double.valueOf(mLat1), Double.valueOf(mLon1)),
    ...
    /**
     * @Title: addUnit @Description: 為距離添加單位的 @param distance @return @return
     * String @throws
     */
    ...
    /**
     * @Title: NaviByWeb @Description: 通過web導航 @param mLat1 @param mLon1 @param
     * mLat2 @param mLon2 @param mContext @return @return boolean @throws
     */
    public static boolean NaviByWebBaidu(double mLat1, double mLon1, double mLat2, double mLon2, Context mContext) {
        if ((Double) mLat1 instanceof Double && (Double) mLon1 instanceof Double && (Double) mLat2 instanceof Double
                && (Double) mLon2 instanceof Double && mLat1 != 0 && mLon1 != 0 && mLat2 != 0 && mLon2 != 0) {
     ...
     * mLat2 @param mLon2 @param mContext @return @return boolean @throws
     */
    public static boolean NaviByWebBaidu(String mLat1, String mLon1, String mLat2, String mLon2, Context mContext) {
        if (mLat1 != null && !mLat1.equals("") && !mLat1.equals("null") && !mLat1.equals("0") && mLon1 != null
                && !mLon1.equals("") && !mLon1.equals("null") && !mLon1.equals("0") && mLat2 != null
                && !mLat2.equals("") && !mLat2.equals("null") && !mLat2.equals("0") && mLon2 != null
                && !mLon2.equals("") && !mLon2.equals("null") && !mLon2.equals("0")) {
            LatLng pt1 = new LatLng(Double.valueOf(mLat1), Double.valueOf(mLon1));
            LatLng pt2 = new LatLng(Double.valueOf(mLat2), Double.valueOf(mLon2));
            // 构建 导航参数
            // NaviPara para = new NaviPara();
            // para.startPoint = pt1;
            // para.endPoint = pt2;
    ...
    /**
     * @Title: NaviByBaidu @Description: 通過百度客戶端導航 @param mLat1 @param
     * mLon1 @param mLat2 @param mLon2 @param mContext @return @return
     * boolean @throws
     */
    ...
    /**
     * @Title: getSuggestion @Description: 通過關鍵字及城市名搜索對應地區
     * city城市名-district區名-locName熱點名 @param cityName @param keyName @param
    ...
    /**
     * @Title: destroySuggestion @Description: 銷毀及置空搜索相關對象 @return void @throws
     */
    ...
    /**
     * @Title: getLocationByGeoCode @Description: 獲取坐標通過geo搜索 @param
     * mLocationBean @param listener @return void @throws
     */
    ...
    /**
     * @Title: getPoiByGeoCode @Description: 根据经纬度获取周边热点名 @param lat @param
     * lon @param listener @return void @throws
     */
    ...
    /**
     * @Title: destroyGeoCode @Description: 銷毀及置空geo搜索相關對象 @return void @throws
     */
    ...
    /**
     * @Title: getPoiByPoiSearch @Description: 通過關鍵字及城市名搜索對應地區
     * city城市名-addstr地址-locName熱點名-latlon经纬度-uid百度自定义id @param cityName @param
     * keyName @param pageNum @param listener @return void @throws
     */
    ...
    /**
     * @Title: getPoiDetailByPoiSearch @Description: 获得所谓的详细信息 @param uid @param
     * listener @return void @throws
     */
            ...
            if (res.getAllPoi() != null) {
                for (PoiInfo info : res.getAllPoi()) {
                    try {
                        ...
                        searchPoiList.add(cityPoi);
                        Log.i("huan", "lat==" + info.location.latitude + "--lon==" + info.location.longitude + "--热点名=="
                                + info.name);
                    } catch (Exception e) {
    ...
    /**
     * @Title: destroyPoiSearch @Description: 銷毀及置空poisearch搜索相關對象 @return
     * void @throws
     */
